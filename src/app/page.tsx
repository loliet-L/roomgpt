  ...
  return (
   <main className='my-auto flex gap-10 p-11 lg:flex-row flex-col justify-center lg:justify-around items-center'>
    <div className='flex relative max-w-xl flex-col items-center gap-5  gradient-bg'>
      <h1 className='text-white text-5xl font-bold text-center '>Redesign rooms in seconds{" "} 
      <span className='text-blue-700'>using AI</span></h1>
      <p className="text-gray-500 text-lg text-center">
        ...
        <Link href={"/room"}>
          <button className='bg-blue-500 hover:opacity-90 text-white font-semibold px-5 py-3 rounded-lg'>
            Redesign your room
          </button>
        </Link>
    </div>
